...
geth --rpc --rpcaddr "0.0.0.0" --rpccorsdomain "*" --rpcapi "db,eth,net,web3,personal" --rpcvhosts=devnet --dev --password ~/.accountpassword --mine --minerthreads 1 --extradata "Kunstmaan"
